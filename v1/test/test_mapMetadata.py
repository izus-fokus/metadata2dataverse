...
class TestMetadataMapperEndpoints(unittest.TestCase):
    ...
    #     with open(r'test/input/priority_test.txt', 'rb') as f:
    #         file_content = f.read()
    ...
    #     with open(r'test/input/merge_test1.txt', 'rb') as f:
    #         file_content = f.read()
    #         response = self.client.post('/metadata/harvester?method=edit', data=file_content, headers={'Content-Type':'plain/txt'})
    #         self.assertEqual(response.status_code, 200)
    ...
    #     with open(r'test/input/merge_test2.txt', 'rb') as f:
    #         file_content = f.read()
    #         response = self.client.post('/metadata/harvester?method=edit', data=file_content, headers={'Content-Type':'plain/txt'})
    #         self.assertEqual(response.status_code, 200)
    ...
    #     with open(r'test/input/merge_test3.txt', 'rb') as f:
    #         file_content = f.read()
    #         response = self.client.post('/metadata/harvester?method=edit', data=file_content, headers={'Content-Type':'plain/txt'})
    #         self.assertEqual(response.status_code, 200)
    ...
    #     with open(r'test/input/unterschiedliche_felder.txt', 'rb') as f:
    #         file_content = f.read()
    #         response = self.client.post('/metadata/harvester?method=edit', data=file_content, headers={'Content-Type':'plain/txt'})
    #         self.assertEqual(response.status_code, 200)
    ...
    #     with open(r'test/input/adder.txt', 'rb') as f:
    #         file_content = f.read()
    #         response = self.client.post('/metadata/harvester?method=edit', data=file_content, headers={'Content-Type':'plain/txt'})
    #
    #         self.assertEqual(response.status_code, 200)
    ...
    #     with open(r'test/input/unknown_key.txt', 'rb') as f:
    #         file_content = f.read()
    #         response = self.client.post('/metadata/harvester?method=edit', data=file_content, headers={'Content-Type':'plain/txt'})
    #         self.assertEqual(response.status_code, 200)
    #         self.assertEqual(response.json, {'fields': [{'typeName': 'title', 'value': 'Test titel'},{'typeName': 'dateOfDeposit', 'value': self.actual_date}]})
    ...
    #     with open(r'test/input/single_multiple.txt', 'rb') as f:
    #         file_content = f.read()
    #         response = self.client.post('/metadata/harvester?method=edit', data=file_content, headers={'Content-Type':'plain/txt'})
    #         self.assertEqual(response.status_code, 200)
    ...
    #     # rule 1
    #     # dataverse bug: compoundfield wirft 500 Fehler
    #     with open(r'test/input/rule.txt', 'rb') as f:
    #         file_content = f.read()
    #         response = self.client.post('/metadata/harvester?method=edit', data=file_content, headers={'Content-Type':'plain/txt'})
    #         self.assertEqual(response.status_code, 200)
    ...
    #
    #     # rule 2
    #     with open(r'test/input/rule2.txt', 'rb') as f:
    #         file_content = f.read()
    #         response = self.client.post('/metadata/harvester?method=edit', data=file_content, headers={'Content-Type':'plain/txt'})
    #         self.assertEqual(response.status_code, 200)
    ...
    #     with open(r'test/input/controlled_voc.txt', 'rb') as f:
    #         file_content = f.read()
    #         response = self.client.post('/metadata/harvester?method=edit', data=file_content, headers={'Content-Type':'plain/txt'})
    #         self.assertEqual(response.status_code, 200)
    ...
    #         self.assertEqual(x.status_code, 200)
    #
    #     with open(r'test/input/test_jsonld_reader.jsonld', 'rb') as f:
    #         file_content = f.read()
    ...
    #         self.assertIn('warnings', response.json)
    #
    #     with open(r'test/input/opendihu_example.jsonld', 'rb') as f:
    #         file_content = f.read()
    #         response = self.client.post('/metadata/m4i?method=edit', data=file_content, headers={'Content-Type':'application/jsonld'})
