...
class TestConfig(unittest.TestCase):
    ...
    def test_add_rule(self):
        self.config.add_rules({"trigger": "contact.role","type": "rule","priority": 1,"trigger_values": ["Producer", "Distributor"], "Producer": [{"source_key": "contact.name", "target_key": "producerName"}, {"source_key": "contact.affiliation.name", "target_key": "producerAffiliation"}, {"source_key": "contact.affiliation.idElement", "target_key": "producerAbbreviation"}], "Distributor": [{"source_key": "contact.name", "target_key": "distributorName"}, {"source_key": "contact.affiliation.name", "target_key": "distributorAffiliation"}, {"source_key": "contact.affiliation.idElement", "target_key": "distributorAbbreviation"}]})
